...
export const hubspotContactsSchema: CsvSchema = {
  ...
  optionalColumns: [
    ...
    'Blood Draw Date',
    'Blood Requisition Sent date',
    'Blood Dashboard Published',
    'Blood Dashboard Published Date',
    'Clinician Review Ready Date',
    'Results Available Date',
    'Results Extracted to Oracle',
    'EPI Results Received Date',
    'Epigenetics Dashboard Unlocked',
    'Epigenetics Dashboard Unlocked Date',
    'Medical Plan Sent At',
    'Dashboard Unlocked',
    'Dashboard Unlocked Date',
    'Re-test Blood Requisition Sent Date',
    'Re-test Blood Results Received Date',
    'Re-test Epi Results Back Date',
    'Re-test Dashboard Published Date',
    'Last Activity Date',
    'Last Test Date',
  ],
  strippedColumns: [
  ...
  canonicalColumns: [
    ...
    'blood_draw_date',
    'blood_requisition_sent_date',
    'blood_dashboard_published',
    'blood_dashboard_published_date',
    'clinician_review_ready_date',
    'results_available_date',
    'results_extracted_to_oracle',
    'epi_results_received_date',
    'epigenetics_dashboard_unlocked',
    'epigenetics_dashboard_unlocked_date',
    'medical_plan_sent_at',
    'dashboard_unlocked',
    'dashboard_unlocked_date',
    'retest_blood_requisition_sent_date',
    'retest_blood_results_received_date',
    'retest_epi_results_back_date',
