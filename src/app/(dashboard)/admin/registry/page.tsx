...
const dataSources: DataSource[] = [
  ...
  },
  {
    id: 'social_organic',
    name: 'Social Organic',
    system: 'Manual aggregation (Meta + others)',
    connectionMethod: 'csv-upload',
    ...
    metricsTotal: 5,
    dependencies: [],
    notes: 'Followers + engagement metrics in long format. Sourced from "Social Media Followers" and "Social Media Views" sheets in TMRW_MARKETING_DATA.',
  },
  {
    id: 'pelagonia',
