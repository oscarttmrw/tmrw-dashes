    ...
    <span className="relative inline-flex">
      ...
      {open && (
        <>
          ...
          <div className="absolute right-0 top-6 z-50 w-72 max-w-[calc(100vw-2rem)] rounded-lg border border-dash-border bg-dash-surface p-3 shadow-[0_4px_24px_rgba(0,0,0,0.08)]">
